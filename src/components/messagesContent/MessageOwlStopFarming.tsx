...
import OwlImg from '@assets/imgs/owls/owlFunny.png';

export const MessageOwlStopFarming: FC = () => {
  ...
  return (
    <Box>
      ...
      >
        {t('pages.farming.greateResult')}
        <Box color="#FAC743">{t('pages.farming.wellDone')}</Box>
      </Box>
    </Box>
  );
}